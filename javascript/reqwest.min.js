...
! function(e, t, n) {
    ...
    function handleReadyState(e, t, n) {
        return function() {
            ...
            e.request && e.request[readyState] == 4 && (e.request.onreadystatechange = noop, succeed(e) ? t(e.request) : n(e.request))
        }
    }
    ...
    function buildParams(e, t, n, r) {
        var i, s, o, u = /\[\]$/;
        if (isArray(t))
            for (s = 0; t && s < t.length; s++) o = t[s], n || u.test(e) ? r(e, o) : buildParams(e + "[" + (typeof o == "object" ? s : "") + "]", o, n, r);
    ...
    return Reqwest.prototype = {
        ...
        if (isArray(e))
            ...
            for (n in e) e.hasOwnProperty(n) && buildParams(n, e[n], i, u);
